...
### Logo
Archivo: `brand-assets/logo_no_background.png` (copia en `public/logo.png` para uso en el sitio)
...
- `brand-assets/logo_no_background.png` — logo oficial (copia en `public/logo.jpeg`)
